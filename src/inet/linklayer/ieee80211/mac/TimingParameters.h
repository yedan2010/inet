...
class INET_API TimingParameters
{
    ...
    public:
        TimingParameters(simtime_t slotTime, simtime_t sifsTime, simtime_t aifsTime, simtime_t eifsTime, simtime_t pifsTime, simtime_t rifsTime, int cwMin, int cwMax, int cwMulticast, simtime_t txopLimit) :
            slotTime(slotTime),
            sifsTime(sifsTime),
            aifsTime(aifsTime),
            eifsTime(eifsTime),
        ...
        virtual int getCwMin() const { return cwMin; }
        virtual int getCwMax() const { return cwMax; }
        virtual int getCwMulticast() const { return cwMulticast; }
